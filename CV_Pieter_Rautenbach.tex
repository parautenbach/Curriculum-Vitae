...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% school %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \cvsubsection{Primary and Secondary Level}
    ...
    \cvsubsubsection{Cultural}
      \begin{cvenv}
        \cvitem{1998}{\href{http://www.unisa.ac.za/}{UNISA}: 
...
\begin{cvenv}
  ...
  \iftoggle{public}{}{%
    \cvitem{Phone}{N/A}%{\pp}27 (0)82 822 8538 (until July 13, 2013)}
...
\begin{cvenv}
  ...
  \iftoggle{public}{}{%
    ...
    \cvitem{E-mail}{\href{mailto:\goof@yilaconsulting.com}{\goof@yilaconsulting.com}}
  }
...
\begin{cvenv}
  ...
  \cvitem{Capacity}{Personal acquaintance and mentor; \\
                    Lectured to the author; \\
