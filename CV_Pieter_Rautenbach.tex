...
\begin{cvenv}
  ...
  \cvitem{Postal address}{PO Box 12843, Die Boord, 
                          7613, South Africa}
  \cvitem{Mobile}{\mbox{{\pp}27 82 824 3879}}
...
\begin{cvenv}
  \cvitem{Lead Architect and Data Scientist \\ (Sep.~2013--)}
...
\begin{cvenv}
  ...
  \cvitem{RDBMSs}{MySQL, MS SQL Server, PostgreSQL, Greenplum}
  \cvitem{NoSQL}{Couchbase, Hadoop family, Titan Graph DB}
...
\begin{cvenv}
  ...
  \cvitem{Documentation}{MediaWiki, MS Sharepoint, JavaDoc, JSDoc, Doxygen, etc.}
\end{cvenv}
