...
\begin{cvenv}%[!{--}]
  ...
  \cvitem{Recreational}{Mountain biking; Jogging; Hiking; Reading and writing; 
...
%  \cvitem{E-mail}{\href{mailto:parautenbach@gmail.com}{parautenbach@gmail.com}}
%\end{cvenv}


  \begin{cvenv}
    \cvitem{Online}{\href{http://www.whatsthatlight.com/index.php/contact/}
                         {www.whatsthatlight.com/contact}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% school %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \cvsubsection{Primary and Secondary Level}
    ...
    \cvsubsubsection{Cultural}
      \begin{cvenv}
        \cvitem{1998}{UNISA\footnote{University of South Africa}: 
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:adam.nachman@gmail.com}{adam.nachman@gmail.com}}
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:gerhard@yilaconsulting.com}{gerhard@yilaconsulting.com}}
  \cvitem{Capacity}{Former colleague and mentor at SWiST Group Technologies and 
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:aslam.khan@factor10.com}{aslam.khan@factor10.com}}
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:swanepoel@stonethree.com}{swanepoel@stonethree.com}}
  \cvitem{Capacity}{Former colleague at Stone Three Signal Processing and business partner 
                    for outsourced development for MXit Lifestyle}
\end{cvenv}
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:herbst@dip.sun.ac.za}{herbst@dip.sun.ac.za}}
  \cvitem{Capacity}{Study leader for M.Sc.Eng.~thesis}
\end{cvenv}
...
\begin{cvenv}
  ...
  %\cvitem{E-mail}{\href{mailto:jeroux@sun.ac.za}{jeroux@sun.ac.za}}
  \cvitem{Capacity}{Personal acquaintance and mentor; Lectured to the author; 
                    Author was tutor for lecturer's subjects}
\end{cvenv}
