...
\begin{cvenv}
  \cvitem{Qualification}{Senior Certificate with an A aggregate (distinction above 80\%)}
...
I have managed several teams and successfully delivered projects over more than 10 years 
using practical agile principles. I have a passion for process and system automation, and 
...
business process modelling. I have contributed to start-ups three, lived through one major sale 
of shares and one acquisition, while being on the due diligence team on both occasions. 
...
\begin{cvenv}
  \cvitem{Software Development Manager \& \\ General Manager \\ (Dec.~2015--)}
...
\begin{cvenv}
  \cvitem{2017}{OfferZen: \href{https://www.offerzen.com/blog/how-takealot-com-is-scaling-their-developer-team}
...
\begin{cvenv}
  ...
  \cvitem{RDBMSs}{MySQL, MS SQL Server, PostgreSQL, Greenplum, AWS Redshift}
  ...
  \cvitem{Queueing}{Microsoft MQ, RabbitMQ, Kafka}
  \cvitem{Web Frameworks}{ExpressJS, AngularJS, Django}
  \cvitem{Analytics}{Google Analytics, KISSmetrics}
  \cvitem{Cloud Services}{Amazon Web Services, Linode, Microsoft Azure}
...
\begin{cvenv}
  ...
  \cvitem{Other}{\LaTeXe, Microsoft Office Suite}
\end{cvenv}
...
\cvsection{Achievements and Involvement}
  \cvsubsection{Post-tertiary Level}
    ...
    \begin{cvenv}
      ...
      \cvitem{2007--2013}{Trustee of the Mxit workers trust}
    \end{cvenv}
    ...
    \cvsubsubsection{Sport and Physical Activities}
      \begin{cvenv}
        \cvitem{2017}{Mountain biking personal best: \\ Top 100 Argus Cape Town Cycle Tour MTB event}
    ...
    \cvsubsubsection{Other}
      \begin{cvenv}
        \cvitem{2013--}{External examiner for master's theses at Stellenbosch University}
      \end{cvenv}
...
\begin{cvenv}
  \cvitem{Marnus~Freeman}{Technical Director at Mxit (2005--2013} %(2010--2013)
...
\begin{cvenv}
  \cvitem{Adam~Nachman}{Software Architect and Team Lead at Mxit (2010--2013)} %(2010--2013)
  %\cvitem{Company}{Mxit Lifestyle (Pty) Ltd (\href{http://www.mxit.com/}{www.mxit.com})}
  \iftoggle{public}{}{%
...
\begin{cvenv}
  \cvitem{P.W.~Nel}{Chief Technical Officer at Mxit (2008--2010)}
...
\begin{cvenv}
  ...
  \cvitem{Capacity}{Industry associate and provided training services to Mxit (2009--2012)}
\end{cvenv}
